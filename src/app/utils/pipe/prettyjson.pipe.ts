...
@Pipe({
  name: 'prettyjsoncustom',
  pure: true
})
export class PrettyJsonCustomPipe implements PipeTransform {
  ...
  private applyColors(obj: any, showNumebrLine: boolean = false, padding: number = 4) {
